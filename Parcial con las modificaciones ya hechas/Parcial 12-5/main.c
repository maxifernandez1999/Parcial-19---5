...
int main()
{
    ...
    do
    {
        ...
        printf("18) porcentaje que tengo de mujeres sobre el total de clientes\n");
        ...
        switch(opcion)
        {
            ...
            break;
            case 2:
                mostrarMascota(listadoMascota, M, listadoDuenio, D,tipoRaza,R);
            ...
            case 9:
                ...
                {
                    case 1:
                        OrdenasMascotasPorTipo(listadoMascota, M,listadoDuenio,D,1,tipoRaza,R);
                    break;
                    case 2:
                        OrdenasMascotasPorTipo(listadoMascota, M,listadoDuenio,D,2,tipoRaza,R);
                    break;
                    default:
                    break;
                }
            ...
            break;
            case 13:
                listarMascotasPorTipo(listadoMascota, M,tipoRaza,R);
            break;
            case 14:
