...
void listarMascotasPorTipo(sMascota mascota[], int tamMascota, sRaza tipoRaza[], int tamRaza)
{
    int i;
    int j;
    printf("**********************RARO*********************\n");
    ...
    for(i = 0; i < tamMascota;i++) // recorre el vector
    {
        if(mascota[i].estado == OCUPADO)
        {
            for(j = 0;j < tamRaza;j++)
            {
                if(mascota[i].idRaza == tipoRaza[j].idRaza && strcmpi(mascota[i].tipo, "raro")==0)
                {
                   printf("%15s \t%12s %8d\n", mascota[i].nombre, tipoRaza[j].Descripcion, mascota[i].edad);
                }
            }
        }
    }
    ...
    for(i = 0; i < tamMascota;i++) // recorre el vector
    {
        if(mascota[i].estado == OCUPADO)
        {
            for(j = 0;j < tamRaza;j++)
            {
                if(mascota[i].idRaza == tipoRaza[j].idRaza && strcmpi(mascota[i].tipo, "gato")==0)
                {
                   printf("%15s \t%12s %8d\n", mascota[i].nombre, tipoRaza[j].Descripcion, mascota[i].edad);
                }
            }
    ...
    for(i = 0; i < tamMascota;i++) // recorre el vector
    {
        if(mascota[i].estado == OCUPADO)
        {
            for(j = 0;j < tamRaza;j++)
            {
                if(mascota[i].idRaza == tipoRaza[j].idRaza && strcmpi(mascota[i].tipo, "perro")==0)
                {
                   printf("%15s \t%12s %8d\n", mascota[i].nombre, tipoRaza[j].Descripcion, mascota[i].edad);
                }
            }
