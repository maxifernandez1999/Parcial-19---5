...
void mostrarDuenio(sDuenio duenio[],int tam)
{
    int i;
...
int modificarDuenio(sDuenio duenio[], int tam)
{
    int aux;
    int i;
    int opcion;
...
void promedioEntreVaronesYMujeres(sDuenio duenio[], int tam)
{
    ...
    float porcentajeVarones;
    float porcentajeMujeres;
    float promedioMujeresVarones;
    ...
    for(i = 0; i < tam; i++)
    {
        ...
        if(duenio[i].sexo == 'm')
        {
            contadorVarones++; // cuenta cuantos de esos duenios son varones
        }
        if(duenio[i].sexo == 'f')
        {
            contadorMujeres++; // cuenta cuantos de esos duenios son mujeres
        }
    }
    promedioVarones = (float)contadorTotalDuenios / contadorVarones; // calcula el promedio de varones
    promedioMujeres = (float)contadorTotalDuenios / contadorMujeres; // calcula el promedio de mujeres
    promedioMujeresVarones = (float)contadorVarones / contadorMujeres; // calcula el promedio entre varones y mujeres
    porcentajeMujeres = (float)contadorMujeres / contadorTotalDuenios * 100; // porcentaje mujeres

    // muestra los datos
    printf("----------INFORMACION DUENIOS------------------\n");
    printf("-----------------------------------------------\n");
    printf("En total hay ingresados %d duenios\n", contadorTotalDuenios);
    printf("-----------------------------------------------\n");
    printf("En el listado de duenios hay %d mujeres\n", contadorMujeres);
    printf("-----------------------------------------------\n");
    printf("En el listado de duenios hay %d varones\n", contadorVarones);
    printf("-----------------------------------------------\n");
    printf("El promedio de varones es de: %.2f\n", promedioVarones);
    printf("-----------------------------------------------\n");
    printf("El promedio de mujeres es de: %.2f\n",promedioMujeres);
    printf("-----------------------------------------------\n");
    printf("El promedio entre varones y mujeres es de: %.2f\n", promedioMujeresVarones);
    printf("-----------------------------------------------\n");
